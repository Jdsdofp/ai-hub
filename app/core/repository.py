...
#     # ======================================================================
# # EDGE DEVICES — Adicionar no repository.py (seção vision_edge_devices)
# # ======================================================================

# # --- REPOSITORY METHODS (colar dentro da classe VisionRepository) -----
...
#                     (company_id, device_code, device_name, site_id, zone_id, api_base_url, active, last_heartbeat)
...
#                 company_id, device_code, device_name,
#                 site_id, zone_id, api_base_url,
#             ))
...
#         except Exception as e:
#             logger.error(f"register_edge_device error: {e}")
#             return None
...
#             return True
#         except Exception as e:
#             logger.error(f"heartbeat_edge_device error: {e}")
#             return False

#     async def list_edge_devices(self, company_id: int, active_only: bool = True) -> list:
#         """Lista dispositivos edge da empresa."""
#         try:
...
#             for r in rows:
#                 d = dict(r)
#                 # Calcula status online (heartbeat < 2 minutos)
...
#             return result
#         except Exception as e:
#             logger.error(f"list_edge_devices error: {e}")
#             return []

#     async def deactivate_edge_device(self, company_id: int, device_code: str) -> bool:
#         """Desativa um dispositivo edge."""
#         try:
#             await db.execute(
#                 "UPDATE vision_edge_devices SET active = 0 WHERE company_id = %s AND device_code = %s",
#                 (company_id, device_code),
#             )
#             return True
#         except Exception as e:
#             logger.error(f"deactivate_edge_device error: {e}")
#             return False
