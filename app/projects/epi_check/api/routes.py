...
#         if not people:
#             return {"synced": 0, "skipped": 0, "errors": [], "message": "No people found in face engine"}
...
#             person_code = person.get("person_code") or person.get("code")
#             person_name = person.get("person_name") or person.get("name") or ""
#             badge_id    = person.get("badge_id") or ""
